...
export const CATEGORY_FIELDS = {
  ...
  'offroad-festivals': {
    ...
    festivalTypeOptions: [
      { value: 'Community-Treffen',      label: 'Community-Treffen' },
      { value: 'Hersteller-Event',       label: 'Hersteller-Event' },
      { value: 'Demo-/Test-Event',       label: 'Demo-/Test-Event' },
      { value: 'Rennen integriert',      label: 'Rennen integriert' },
      { value: 'Messe/Expo',             label: 'Messe/Expo' },
