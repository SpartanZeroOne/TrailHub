...
const NAV_ITEMS = [
  ...
  {
    id: 'organizers', label: 'Organizer', path: '/admin/organizers',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: 'users', label: 'User', path: '/admin/users',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: 'csv-import', label: 'CSV Import', path: '/admin/csv-import',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    id: 'settings', label: 'Einstellungen', path: '/admin/settings',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <aside className={`${sidebarOpen ? 'w-60' : 'w-16'} flex-shrink-0 flex flex-col bg-stone-900 border-r border-stone-800 transition-all duration-200`}>
        ...
        <div className="px-4 py-3 border-t border-stone-800">
          <button
            ...
            title={!sidebarOpen ? 'Zurück zur App' : undefined}
          >
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
            </svg>
            {sidebarOpen && <span>Zurück zur App</span>}
          </button>
        </div>
      </aside>
